document.addEventListener('DOMContentLoaded', async function () {
    ...
    async function fetchTsidDataForAllLakes() {
        ...
        if (output21Div) {
            ...
            instructionWidget21.innerHTML = `Once all lake forecasts are complete, remember to save the SHEF file and confirm that the public link above shows the correct generation date.<br>It may take 5 to 10 seconds for the changes to appear.`;
